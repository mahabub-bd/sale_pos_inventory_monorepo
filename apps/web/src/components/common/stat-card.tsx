...
export default function StatCard({
  ...
  if (compact) {
    return (
      <div
        className={cn(
          "flex items-center gap-3 p-4 rounded-lg border min-h-20",
          ...
          <div className="flex items-center justify-between gap-2">
            ...
            <div className="h-5 flex items-center">
              {badge ? (
                ...
                <span className="opacity-0 px-2 py-1 text-xs">placeholder</span>
              )}
            </div>
          </div>

          <p className="font-semibold text-base text-gray-800 dark:text-white/90 truncate">
            {value}
          </p>
        </div>
      </div>
  ...
  return (
    <div
      className={cn(
        "relative overflow-hidden rounded-xl border p-4 min-h-28",
        bgColorClasses[bgColor],
        className,
      )}
    >
