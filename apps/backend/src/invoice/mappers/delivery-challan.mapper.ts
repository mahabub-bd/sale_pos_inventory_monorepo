...
export function mapSaleToDeliveryChallan(sale: any): InvoiceBaseDto {
  console.log('Sale data for delivery challan:', JSON.stringify(sale, null, 2));
  ...
  const result: InvoiceBaseDto = {
    ...
    // Include payments for reference (optional for delivery challan)
  ...
  console.log('Mapped delivery challan data:', JSON.stringify(result, null, 2));
  return result;
}
